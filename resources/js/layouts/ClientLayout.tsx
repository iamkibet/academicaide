                ...
                <nav className="w-full bg-[#05ADA3] py-2">
                    <MaxWidthWrapper className="flex w-full items-center justify-between">
                        ...
                        <div className="flex h-full gap-2">
                            <Link
                                href="#"
                                className={`flex h-full items-center gap-2 rounded-lg px-4 py-2 font-medium text-white transition-colors duration-200 hover:bg-[#048e86] ${currentPath === '/client/wallet' ? 'bg-[#048e86] shadow-md' : ''}`}
                            >
